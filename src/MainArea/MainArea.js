    ...
    <div className="MainArea">
      ...
      <div className="Main">
        ...
        <div className="Videos">
          <div className="Video">
            <ReactPlayer
              url="https://www.youtube.com/watch?v=9m4bEm8YmZs&ab_channel=SonyMusicSouth"
              height="170px"
              width="280px"
              controls
            />
            ...
            <div className="Logo">
              ...
              <br></br>
              <br></br>
              <div>Polakatum Para Para Video</div>
            </div>
            <br></br>
        ...
        <div className="Videos">
          <div className="Video">
            <ReactPlayer
              url="https://www.youtube.com/watch?v=nCNqPgXDYhY&ab_channel=SonyMusicSouth"
              height="170px"
              width="280px"
              controls
            />
        ...
        <div className="Videos">
          <div className="Video">
            <ReactPlayer
              url="https://www.youtube.com/watch?v=pgfUzQ8nzBY&ab_channel=ThinkMusicIndia"
              height="170px"
              width="280px"
              controls
            />
            ...
            <div className="Logo">
              ...
              <br></br>
              <br></br>
              <div>Karnan Official Teaser</div>
            </div>
            <br></br>
        ...
        <div className="Videos">
          <div className="Video">
            <ReactPlayer
              url="https://www.youtube.com/watch?v=oAa5jfKylgc&ab_channel=ThinkMusicIndia"
              height="170px"
              width="280px"
              controls
            />
